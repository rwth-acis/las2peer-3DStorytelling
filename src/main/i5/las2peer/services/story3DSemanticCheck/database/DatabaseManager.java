package i5.las2peer.services.story3DSemanticCheck.database;
...
public class DatabaseManager {
   ...
   * 
   * @param jdbcDriverClassName driver class name
   * @param jdbcLogin the login name
   * @param jdbcPass the login password
   * @param jdbcUrl the url
   * @param jdbcSchema the schema
   * 
   */
